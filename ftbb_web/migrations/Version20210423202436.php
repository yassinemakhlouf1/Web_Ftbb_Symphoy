 ...
 */
final class Version20210423202436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE password_id password_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE comment CHANGE client_id client_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY likes_ibfk_3');
        $this->addSql('ALTER TABLE likes CHANGE id_client id_client INT DEFAULT NULL');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7D4AE9FB1C FOREIGN KEY (id_comment) REFERENCES comment (id)');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7DDCA7A716 FOREIGN KEY (id_article) REFERENCES article (article_id)');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7DE173B1B8 FOREIGN KEY (id_client) REFERENCES client (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE password_id password_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE comment CHANGE client_id client_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT comment_ibfk_2 FOREIGN KEY (client_id) REFERENCES client (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_49CA4E7D4AE9FB1C');
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_49CA4E7DDCA7A716');
        $this->addSql('ALTER TABLE likes DROP FOREIGN KEY FK_49CA4E7DE173B1B8');
        $this->addSql('ALTER TABLE likes CHANGE id_client id_client INT NOT NULL');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT likes_ibfk_1 FOREIGN KEY (id_comment) REFERENCES comment (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT likes_ibfk_2 FOREIGN KEY (id_article) REFERENCES article (article_id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT likes_ibfk_3 FOREIGN KEY (id_client) REFERENCES client (id) ON UPDATE CASCADE ON DELETE CASCADE');
