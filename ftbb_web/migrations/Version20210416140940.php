 ...
 */
final class Version20210416140940 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin DROP FOREIGN KEY Cle_etra_idpass');
        $this->addSql('ALTER TABLE admin CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE password_id password_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE admin ADD CONSTRAINT FK_880E0D763E4A79C1 FOREIGN KEY (password_id) REFERENCES password (password_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin DROP FOREIGN KEY FK_880E0D763E4A79C1');
        $this->addSql('ALTER TABLE admin CHANGE id id INT NOT NULL, CHANGE password_id password_id INT NOT NULL');
        $this->addSql('ALTER TABLE admin ADD CONSTRAINT Cle_etra_idpass FOREIGN KEY (password_id) REFERENCES password (password_id) ON UPDATE CASCADE ON DELETE CASCADE');
