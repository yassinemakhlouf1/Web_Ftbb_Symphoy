 ...
 */
final class Version20210426112702 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE is_verified is_verified TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE client CHANGE photo_url photo_url VARCHAR(255) NOT NULL, CHANGE id_cart id_cart INT NOT NULL, CHANGE is_verified is_verified TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE is_verified is_verified VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`');
        $this->addSql('ALTER TABLE client CHANGE photo_url photo_url VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE id_cart id_cart INT DEFAULT NULL, CHANGE is_verified is_verified VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`');
